...
(function ($) {
    ...
    for (var i = 0; i < rows; i++){
      ...
      for (var k = 1; k <= 7; k++){
        ...
        if (d > 0 && d <= thisMonthDays){
          ...
          if (tdId >= today && tdId <= endDay) {   
            html += '<td class="valid-hook datebox" data-week="' + (k - 1) + '" data-id="' + tdId + '"><b>' + d + '</b><div class="data-hook"></div></td>';
          } else {
            //html += '<td class="disabled"><b>' + d + '</b></td>';
            html += '<td class="disabled datebox" data-week="' + (k - 1) + '" data-id="' + tdId + '"><b>' + d + '</b><div class="data-hook"></div></td>';
          }
        } else {
          html += '<td>&nbsp;</td>';
        }
  ...
  fn.renderDataToTalbe = function () {
    ...
    this.calendar.find('.datebox').each(function () {
  ...
  fn.initSettingWindow = function () {
    ...
    */
    ...
    html += '       <button class="btn-confirm">设置</button>';
