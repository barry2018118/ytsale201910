...
var settings = {
	...
	upload_url: ctx + '/manage/project/fileupload/contract',
	file_post_name: "uploadfile",
	post_params: {"dir": $("#uploadPath").attr("path")},
	file_size_limit: "10 MB",
	file_types: "*.jpg;*.JPG;*.jpeg;*.JPEG;*.png;*.PNG;*.gif;*.GIF;*.doc;*.DOC;*.docx;*.DOCX;*.zip;*.ZIP;*.rar;*.RAR",
...
function fileQueueError(file, errorCode, message) {
	var progress = new FileProgress(file, this.customSettings.progressTarget) ;
	progress.setError() ;
	progress.setStatus("上传文件格式错误，文件不能超过10MB!") ;
	progress.toggleCancel(false) ;
}