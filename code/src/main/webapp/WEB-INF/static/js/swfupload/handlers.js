...
function getFileIcon(ext){
	var _fileIcons = 'xls|xlsx|doc|docx|ppt|pptx|pdf|flv|mp4|swf|ppt|pptx|jpg|jpeg|gif|png|zip|rar';
    var iconStyle='def';
    if(_contains(_fileIcons,ext,true)){
    	iconStyle=ext;
    }
    return iconStyle;
};