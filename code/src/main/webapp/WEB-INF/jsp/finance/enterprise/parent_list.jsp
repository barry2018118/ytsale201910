    ...
    <div class="modal-dialog pd-t80" style="width:880px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">导出供应商报表</h4>
            </div>
...
<script type="text/javascript">
    ...
    var TableInit = function() {
        ...
        oTableInit.Init = function() {
            $('#platformEnterprise_table_details').bootstrapTable({
                ...
                url : '${ctx}/finance/enterprise/parent/search',
                method : 'get',
    ...
    function toReport(parentId) {
        var requestUrl = "${ctx}/finance/enterprise/parent/" + parentId + "/report" ;
        var requestData = {} ;
