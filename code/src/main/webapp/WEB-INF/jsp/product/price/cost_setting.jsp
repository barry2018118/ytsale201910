...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>商品</span>&nbsp;&gt;&nbsp;<span>设置商品</span>&nbsp;&gt;&nbsp;<span class="dq">设置【${supplierProduct.name}】成本</span>
    </h1>
    <!--列表上方索引 E-->
    <!--返回按钮 S-->
        ...
        <div class="col-lg-12">
            <div class="widget-container fluid-height">
                <div class="heading tabs">
                    <div class="pull-left">设置【${supplierProduct.name}】成本 &nbsp;&nbsp;
                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input class="form-control"  type="text" name="costPrice" id="costPrice"/>
                                        </div>
                                         <div class="col-md-3 red-tag tag">
                                            <span hidden="true" for="costPrice" class="error"></span>
                                        </div>
...
$(document).ready(function() {
    ...
    zxCalendar = $.CalendarPrice({
      ...
      dateChange: function(setData){
        //console.log(setData);
        _setPrice=setData['costPrice'];
        if(!checkAmount(_setPrice)){
            return false;
        }
        return settingCostPriceDate(${supplierProduct.id},setData.date,_setPrice);
      },
      error: function (err) {
...
//        },
     ...
     $("#tab1Form").validate({
        ...
        submitHandler: function() {
           ...
           var _costPrice=$("#costPrice",_tabPane).val();
           //console.log(_startDate,_endDate,_costPrice);
           settingCostPriceSection('${supplierProduct.id}',_startDate,_endDate,'',_costPrice,3);
        }
    });
     ...
     $("#tab2Form").validate({
        ...
        submitHandler: function() {
           ...
           settingCostPriceSection('${supplierProduct.id}',_startDate,_endDate,_week,_costPrice,2);
        }
    });
    ...
    $("#tab3Form").validate({
        ...
        submitHandler: function() {
           ...
           var _startDate=$("#startDate",_tabPane).val();
           var _endDate=$("#endDate",_tabPane).val();
           settingCostPriceSection('${supplierProduct.id}',_startDate,_endDate,'','',1);
        }
    });
...
function loadCostPrice(sproductId,month){
    var resultData={}
    var url = "${ctx}/product/price/load/cost/month" ;
    jQuery.ajax({
        type:"get",
        async: false,
        cache: false,
...
function settingCostPriceSection(sproductId,startDate,endDate,week,costPrice,typex){
    if (iscommiting) {
        return false;
    }
    iscommiting = true;

    var url = "${ctx}/product/price/setting/cost/section" ;
    jQuery.ajax({
        type:"post",
        async: false,
        cache: false,
        ...
        success:function(data) {
            ...
            if(data&&jsonObj&&jsonObj.success==true) {
                ...
                //更新日历数据
                var changeData=loadCostPrice('${supplierProduct.id}',zxCalendar.getCurrMonthStr());
                zxCalendar.update(changeData);
            } else {
                art.dialog({
                    title : '消息',
...
function settingCostPriceDate(sproductId,date,costPrice){
    if (iscommiting) {
        return false;
    }
    iscommiting = true;
    ...
    var isSuccess=false;
    var url = "${ctx}/product/price/setting/cost/day" ;
    jQuery.ajax({
        type:"post",
        async: false,
        cache: false,
