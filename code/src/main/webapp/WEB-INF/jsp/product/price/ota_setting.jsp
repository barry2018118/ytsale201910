...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>商品</span>&nbsp;&gt;&nbsp;<span>设置商品</span>&nbsp;&gt;&nbsp;<span class="dq">设置【${supplierProduct.name}】渠道售卖价</span>
    </h1>
    <!--列表上方索引 E-->
    <!--返回按钮 S-->
        ...
        <div class="col-lg-12">
            <div class="widget-container fluid-height">
                <div class="heading tabs">
                    <div class="pull-left">设置【${supplierProduct.name}】渠道售卖价 &nbsp;&nbsp;
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4">渠道售卖价：</label>
                                        <div class="col-md-3">
                                            <input class="form-control"  type="text" name="otaPrice" id="otaPrice"/>
                                        </div>
                                         <div class="col-md-3 red-tag tag">
                                            <span hidden="true" for="otaPrice" class="error"></span>
                                        </div>
...
$(document).ready(function() {
    ...
    zxCalendar = $.CalendarPrice({
      ...
      dateChange: function(setData){
        //console.log(setData);
        _setPrice=setData['otaPrice'];
        if(!checkAmount(_setPrice)){
            return false;
        }
        return settingOtaPriceDate(${supplierProduct.id},setData.date,_setPrice);
      },
      error: function (err) {
...
//        },
     ...
     $("#tab1Form").validate({
        ...
        submitHandler: function() {
           ...
           var _otaPrice=$("#otaPrice",_tabPane).val();
           //console.log(_startDate,_endDate,_otaPrice);
           settingOtaPriceSection('${supplierProduct.id}',_startDate,_endDate,'',_otaPrice,3);
        }
    });
     ...
     $("#tab2Form").validate({
        ...
        submitHandler: function() {
           ...
           settingOtaPriceSection('${supplierProduct.id}',_startDate,_endDate,_week,_otaPrice,2);
        }
    });
    ...
    $("#tab3Form").validate({
        ...
        submitHandler: function() {
           ...
           var _startDate=$("#startDate",_tabPane).val();
           var _endDate=$("#endDate",_tabPane).val();
           settingOtaPriceSection('${supplierProduct.id}',_startDate,_endDate,'','',1);
        }
    });
...
function settingOtaPriceSection(sproductId,startDate,endDate,week,otaPrice,typex){
    if (iscommiting) {
        return false;
    }
    iscommiting = true;

    var url = "${ctx}/product/price/setting/ota/section" ;
    jQuery.ajax({
        type:"post",
        async: false,
        cache: false,
        ...
        success:function(data) {
            ...
            if(data&&jsonObj&&jsonObj.success==true) {
                ...
                //更新日历数据
                var changeData=loadOtaPrice('${supplierProduct.id}',zxCalendar.getCurrMonthStr());
                zxCalendar.update(changeData);
            } else {
                art.dialog({
                    title : '消息',
...
function settingOtaPriceDate(sproductId,date,otaPrice){
    if (iscommiting) {
        return false;
    }
    iscommiting = true;
    ...
    var isSuccess=false;
    var url = "${ctx}/product/price/setting/ota/day" ;
    jQuery.ajax({
        type:"post",
        async: false,
        cache: false,
