...
<script type="text/javascript">
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#productCategory_table_details').bootstrapTable({
				...
				url : '${ctx}/product/category/getByName',
				method : 'get',
				...
				columns : [ {
                    ...
                    sortable: true,
		            formatter:function(value, row, index) {
                        var edit = '<a href="javascript:;" onclick="toEditProductCategory(\''+ row.id + '\')">编辑</a>' ;
                        var del = '<a href="javascript:;" onclick="toDeleteProductCategory(\''+ row.id + '\')">删除</a>' ;
                        return edit + '&nbsp;&nbsp;' + del ;
                    }
		        }]
			});
    ...
    function toEditProductCategory(id) {
        var requestUrl = "${ctx}/product/category/" + id + "/toEdit" ;
        var requestData = {} ;
        cserpLoadPage(requestUrl, requestData, 'GET', 'mainContentDiv') ;
    }
	
	function toDeleteProductCategory(id) {
        art.dialog({
            title : '消息',
	...
	function doDeleteProductCategory(id) {
        var url = "${ctx}/product/category/" + id + "/delete" ;
        jQuery.ajax({
            type:"post",
            async: true,    
            cache: false,     
