...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>员工账号</span>&nbsp;&gt;&nbsp;<span class="dq">编辑</span>
    </h1>
    <!--列表上方索引 E-->
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入员工账号（必须为手机号）"
                                       type="text" id="username" name="username" value="${user.username}" maxlength="11">
                            </div>
                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入账号密码（必须包含字母和数字）"
                                       type="text" id="password" name="password"  value="${user.password}"  maxlength="16">
                            </div>
                        </div>
                        <div class="col-md-3 red-tag tag">
