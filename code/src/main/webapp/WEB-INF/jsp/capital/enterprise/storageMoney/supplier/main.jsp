...
<div class="page-title ">
	<!--列表上方索引 S-->
	<h1 class="fl">
		<span>供应商预收款（查看上级供应商对我的预收款)</span>&nbsp;&gt;&nbsp;<span class="dq"></span>
	</h1>
	<!--列表上方索引 E-->
	<!--列表上方右侧按钮 S-->
	<div class="fr">
		<label class="fl" style="line-height:30px; margin-left:10px;">&nbsp;&nbsp;</label>
		<input class="form-control fl datepicker" type="text" style="width:180px;" id="searchName" name="searchName" placeholder="供应商名称" />
...
<script type="text/javascript">
    $(document).ready(function() {
        // 页面初始化完成加载list请求
        var requestUrl = "${ctx}/capital/enterprise/storageMoney/supplier/list" ;
        var requestData = {} ;
