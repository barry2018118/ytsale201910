...
<script type="text/javascript">
    ...
    var TableInit = function() {
        ...
        oTableInit.Init = function() {
            $('#user_table_details').bootstrapTable({
                ...
                url : '${ctx}/capital/enterprise/info/extract/toSearch',
                method : 'get',
    ...
    function toSearch(id) {
        var requestUrl = "${ctx}/capital/enterprise/info/extract/" + id + "/toCard" ;
        var requestData = {} ;
    ...
    function toSearchCard(id) {
        var _url = "${ctx}/capital/enterprise/bankCard/"+id+"/search" ;
        var money = null;
        $.ajax({
            url: _url ,
            type: "post",
