...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>银行卡管理</span>&nbsp;&gt;&nbsp;<span class="dq">编辑</span>
    </h1>
    <!--列表上方索引 E-->
            ...
            <div class="widget-container fluid-height">
                ...
                <div class="widget-content padded">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="所属银行"
                                       type="text" id="bank" name="bank" maxlength="30" value="${card.bank}">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="开户地址"
                                    type="text" id="address" name="address" maxlength="30" value="${card.address}">
                            </div>
                        </div>
                        <div class="col-md-3 red-tag tag">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="银行卡号"
                                       type="text" id="cardNo" name="cardNo" maxlength="40" value="${card.cardNo}">
                            </div>
                        </div>
                        <div class="col-md-3 red-tag tag">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="持卡人（或公司名）"
                                       type="text" id="cardMaster" name="cardMaster" maxlength="30" value="${card.cardMaster}">
                            </div>
                        </div>
                        <div class="col-md-3 red-tag tag">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <textarea maxlength="100" id="remark" name="remark"
                                          placeholder="" class="form-control" rows="5">${card.remark}</textarea>
                            </div>
                        </div>
                        <div class="col-md-3 red-tag tag">
        ...
        $("#editUserForm").validate({
            ...
            submitHandler: function (form) {
                ...
                jQuery(form).ajaxSubmit({
                    type: "post",
                    url: "${ctx}/capital/enterprise/bankCard/${card.id}/edit",
