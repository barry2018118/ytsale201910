...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>预收款</span>&nbsp;&gt;&nbsp;<span class="dq">我对分销商</span>&nbsp;&gt;&nbsp;<span class="dq">查看明细</span>
    </h1>
    <!--列表上方索引 E-->
...
<script type="text/javascript">
    ...
    var TableInit = function() {
        ...
        oTableInitCard.Init = function() {
            $('#user_table_details_card').bootstrapTable({
                ...
                url : '${ctx}/capital/enterprise/storageMoney/distributor/${childId}/CardList',
                method : 'get',
    ...
    function toSearch(id) {
        var requestUrl = "${ctx}/capital/enterprise/storageMoney/distributor/" + id + "/card" ;
        var requestData = {} ;
