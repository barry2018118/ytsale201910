...
<div class="page-title ">
	<!--列表上方索引 S-->
	<h1 class="fl">
		<span>充值</span>&nbsp;&gt;&nbsp;<span class="dq">充值列表</span>
	</h1>
	<!--列表上方索引 E-->
	<!--列表上方右侧按钮 S-->
	<div class="fr">
		<label class="fl" style="line-height:30px; margin-left:10px;">充值时间&nbsp;&nbsp;</label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // 页面初始化完成加载list请求
        var requestUrl = "${ctx}/capital/enterprise/info/recharge/list" ;
        var requestData = {} ;
        ...
        $("#toAddUser").click(function() {
            var requestUrl = "${ctx}/capital/enterprise/info/recharge/toAdd" ;
            var requestData = {} ;
