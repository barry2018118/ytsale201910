...
<div class="page-title ">
	<!--列表上方索引 S-->
	<h1 class="fl">
		<span>银行卡管理</span>&nbsp;&gt;&nbsp;<span class="dq">列表</span>
	</h1>
	<!--列表上方索引 E-->
	...
	<div class="fr">
		...
		<input class="form-control fl" type="text" style="width:180px;" id="searchName" name="searchName" placeholder="卡号" />
...
<script type="text/javascript">
    $(document).ready(function() {
        // 页面初始化完成加载list请求
        var requestUrl = "${ctx}/capital/enterprise/bankCard/list" ;
        var requestData = {} ;
        ...
        $("#toAddUser").click(function() {
            var requestUrl = "${ctx}/capital/enterprise/bankCard/toAdd" ;
            var requestData = {} ;
