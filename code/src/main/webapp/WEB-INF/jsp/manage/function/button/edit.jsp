...
<div class="page-title">
	<h1 class="fl">
		<span>功能注册</span>&nbsp;&gt;&nbsp;<span>功能管理</span>&nbsp;&gt;&nbsp;<span class="dq">编辑子功能</span>
	</h1>
...
<form id="editButtonForm" method="post" action="${ctx}/manage/function/button/${button.id}/edit?t=90" class="form-horizontal">
	<div class="row">
		<div class="col-lg-12">
	        <div class="">
	            <div class="widget-content padded">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<div class="rel">
								<input type="text" id="name" name="name" maxlength="12" class="form-control" placeholder="" value="${button.name}" />
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<div class="rel">
								<input type="text" id="url" name="url" maxlength="50" class="form-control" placeholder="" value="${button.url}" />
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<textarea id="description" name="description" class="form-control" rows="5" maxlength="60">${button.description}</textarea>
						</div>
					</div>
	            </div>
	        </div>
					...
					success: function(data) {
						if(data=="success") {
							art.dialog({
							    ...
							    content: '操作成功' ,
							    close:function() {
							    	var requestUrl = "${ctx}/manage/function/button/list" ;
							    	var requestData = {"actionId": ${action.id}} ;
