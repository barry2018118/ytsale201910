...
<div class="page-title">
	<h1 class="fl">
		<span>功能注册</span>&nbsp;&gt;&nbsp;<span>功能管理</span>&nbsp;&gt;&nbsp;<span class="dq">新建功能</span>
	</h1>
...
<form id="addActionForm" method="post" action="${ctx}/manage/function/action/add?t=90" class="form-horizontal">
	<div class="row">
		<div class="col-lg-12">
	        <div class="">
