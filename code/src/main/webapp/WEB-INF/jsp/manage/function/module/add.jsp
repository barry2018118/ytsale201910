...
<div class="page-title">
	<h1 class="fl">
		<span>功能注册</span>&nbsp;&gt;&nbsp;<span>功能管理</span>&nbsp;&gt;&nbsp;<span class="dq">新建模块</span>
	</h1>
...
<form id="addModuleForm" method="post" action="${ctx}/manage/function/module/add?t=90" class="form-horizontal">
	<div class="row">
		<div class="col-lg-12">
	        <div class="">
	            <div class="widget-content padded">
						...
						<div class="col-md-7" >
							<div class="rel">
								<div id="choiceModuleIcon" class="choiceModuleIcon clearfix">
									<a href="javascript:;" class="active" icon="icon-default">
	            	...
	            	<input type="hidden" id="icon" name="icon" value="icon-default" />
