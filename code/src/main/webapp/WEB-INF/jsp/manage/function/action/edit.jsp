...
<div class="page-title">
	<h1 class="fl">
		<span>功能注册</span>&nbsp;&gt;&nbsp;<span>功能管理</span>&nbsp;&gt;&nbsp;<span class="dq">编辑功能</span>
	</h1>
...
<form id="editActionForm" method="post" action="${ctx}/manage/function/action/${action.id}/edit?t=90" class="form-horizontal">
	<div class="row">
		<div class="col-lg-12">
	        <div class="">
	            <div class="widget-content padded">
	            	<div class="form-group">
						...
						<div class="col-md-7 tag">
							<div class="rel" style="color:#00aae9;">
								${module.name}&nbsp;<span style="color:#333">></span>&nbsp;${menu.name}
							</div>
						</div>
					</div>
	            
					<div class="form-group">
						<label class="control-label col-md-2">功能名称：</label>
						<div class="col-md-7">
							<div class="rel">
								<input type="text" id="name" name="name" maxlength="12" class="form-control" placeholder="" value="${action.name}" />
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<div class="rel">
								<input type="text" id="url" name="url" maxlength="50" class="form-control" placeholder="" value="${action.url}" />
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-md-2">功能备注：</label>
						<div class="col-md-7">
							<textarea id="description" name="description" class="form-control" rows="5" maxlength="60">${action.description}</textarea>
						</div>
					</div>
	            </div>
	        </div>
