...
<div class="page-title">
	<h1 class="fl">
		<span>系统管理</span>&nbsp;&gt;&nbsp;<a href="#"  onclick="gobackdistribution()"><span>权限管理</span></a>&nbsp;&gt;&nbsp;<span class="dq">授权</span>
	</h1>
	<!--返回按钮 S-->
    <button class="btn btn-primary fr btn-top" type="button" onclick="gobackdistribution()"><i class="icon-rotate-left"></i>返回</button>
</div>
  
<form id="distributionForm" method="post" action="${ctx}/manage/role/saveAuthorize?t=90">
<!-- role Id -->
...
<div class="row">
	...
	<div class="widget-content">
		...
		<div class="col-md-12 text-center">
        		<button  type="button"  class="btn btn-footer btn-cancel" onclick="gobackdistribution()">取消</button>
				<a href="javascript:;">
