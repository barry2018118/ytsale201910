...
<script type="text/javascript">
    ...
    var TableInit = function() {
        ...
        oTableInit.Init = function() {
            $('#user_table_details').bootstrapTable({
                ...
                url : '${ctx}/orders/refund/other/getSearch',
                method : 'get',
                ...
                columns : [{
                    ...
                    formatter:function(value, row, index) {
                        ...
                        if(row.enterpriseId == ${id} && row.state == 0){
                            var say = '<a href="javascript:;" onclick="toSet(\''+ row.id + '\');">退款审核</a>' ;
						}else{
                            var say = "";
                        }
                        return  edit +"&nbsp;&nbsp;" + say;
    ...
    function toSearch(id) {
        var requestUrl = "${ctx}/orders/refund/other/" + id + "/toCard" ;
        var requestData = {} ;
        cserpLoadPage(requestUrl, requestData, 'GET', 'mainContentDiv') ;
    }
    function toSet(id) {
        var requestUrl = "${ctx}/orders/refund/other/" + id + "/toSet" ;
        var requestData = {} ;
        cserpLoadPage(requestUrl, requestData, 'GET', 'mainContentDiv') ;
    }
