...
<script type="text/javascript">
                ...
                columns : [ {
                    ...
                    formatter:function(value, row, index) {
                        ...
                        var bay = '<a href="javascript:;"  onclick="sendOrderMessageNo(\''+ row.ordersId + '\')">重新发码</a>' ;
                           // if(row.createdId == ${userId} ){
                                var say ='<a data-toggle="modal" href="#myModal4"  onclick="toexit(\''+ row.id + '\')">退款</a>' ;
                           // }else{
						   //    var say = "";
                           // }
                        str = see + '&nbsp;&nbsp;' + bay + '&nbsp;&nbsp;' + say ;
    ...
    function toCard(id) {
        var requestUrl = "${ctx}/orders/my/" + id + "/toCard" ;
        var requestData = {} ;
