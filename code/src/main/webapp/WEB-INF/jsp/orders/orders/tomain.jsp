...
<div class="page-title " style="height:auto; " >
    <div class="tab-box clear">
        <a href="javascript:;" class="tab " id="view" onclick="toSale();">我的订单</a>
        <a href="javascript:;" class="tab tab-last tab-active" id="views" onclick="toStock();">分销商订单</a>
    </div>
    <!-- tab tab-last  -->
</div>
...
<script type="text/javascript">
    ...
    function toStock() {
        ...
        var requestUrl = "/orders/other/main" ;
        var requestData = {} ;
        cserpLoadPage(requestUrl, requestData, 'GET', 'chart_middle') ;
    }
