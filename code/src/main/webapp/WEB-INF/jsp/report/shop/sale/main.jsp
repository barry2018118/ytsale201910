...
<div class="page-title ">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>统计分析</span>&nbsp;&gt;&nbsp;<span class="dq">销售汇总报表</span>
    </h1>
    <!--列表上方索引 E-->
...
<!-- 列表 -->
<div id="shop_sale_main_area"></div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // 页面初始化完成加载list请求
        var requestUrl = "${ctx}/report/shop/sale/list" ;
        var requestData = {} ;
        cserpLoadPage(requestUrl, requestData, 'GET', 'shop_sale_main_area') ;
