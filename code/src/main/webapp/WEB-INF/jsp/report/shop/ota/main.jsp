...
<div class="page-title ">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>统计分析</span>&nbsp;&gt;&nbsp;<span class="dq">OTA销售报表</span>
    </h1>
    <!--列表上方索引 E-->

    <!--列表上方右侧按钮 S-->
    <div class="fr">
        <label class="fl" style="line-height:30px; margin-left:10px;">渠道名称：&nbsp;&nbsp;</label>
        <select class="form-control fl" id="otaId" name="otaId" style="width:90px;">
            <option value="" selected="selected">全部</option>
            <c:forEach items="${lstOTA}" var="ota" varStatus="s">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // 页面初始化完成加载list请求
        var requestUrl = "${ctx}/report/shop/ota/list" ;
        var requestData = {} ;
        cserpLoadPage(requestUrl, requestData, 'GET', 'shop_ota_main_area') ;
