...
<div class="page-title ">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>统计分析</span>&nbsp;&gt;&nbsp;<span class="dq">分销商销售报表</span>
    </h1>
    <!--列表上方索引 E-->

    <!--列表上方右侧按钮 S-->
    <div class="fr">
        <label class="fl" style="line-height:30px; margin-left:10px;">分销商：&nbsp;&nbsp;</label>
        <input class="form-control fl" type="text" style="width:180px;" id="childName" name="childName" placeholder="分销商" />
...
<!-- 列表 -->
<div id="shop_distributor_main_area"></div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // 页面初始化完成加载list请求
        var requestUrl = "${ctx}/report/shop/distributor/list" ;
        var requestData = {} ;
        cserpLoadPage(requestUrl, requestData, 'GET', 'shop_distributor_main_area') ;
