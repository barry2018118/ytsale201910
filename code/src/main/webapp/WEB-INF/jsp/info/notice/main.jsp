...
<div class="page-title ">
	<!--列表上方索引 S-->
	<h1 class="fl">
		<span>公告管理</span>&nbsp;&gt;&nbsp;<span class="dq">列表</span>
	</h1>
	<!--列表上方索引 E-->

	<!--列表上方右侧按钮 S-->
	<div class="fr">
		<input class="form-control fl" type="text" style="width:180px;" id="searchName" name="searchName" placeholder="公告标题" />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#toAdd").click(function() {
            var requestUrl = "${ctx}/info/notice/toAdd" ;
            var requestData = {} ;
