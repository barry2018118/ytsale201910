...
<style>
    #infoScenicAddForm input.checkbox {
        vertical-align: top;
        margin-right: 5px;
    }
</style>
...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>景区名称</span>&nbsp;&gt;&nbsp;<span class="dq">编辑</span>
    </h1>
    <!--列表上方索引 E-->
    <!--返回按钮 S-->
...
<form id="infoScenicAddForm"  class="form-horizontal">
    <div class="row">
        <div class="col-lg-12">
            <div class="widget-container fluid-height">
                <div class="heading">
                    <div class="pull-left">旅游景区</div>
                </div>
                ...
                <div class="widget-content padded">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入景点名称" type="text" id="name" name="name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <div class="rel">
                                    <%--<input class="form-control" placeholder="请输入景点星级" type="text" id="level" name="level"
                                           value="${entity.level}" maxlength="10" />--%>
                                    <input type="hidden" id="level_val" value="${entity.level}">
                                    <select class="form-control"  placeholder=" " type="text" id="level" name="level"
                                            value="${entity.level}" maxlength="10" >
                        ...
                        <div class="col-md-3 red-tag tag">
                            <font id="levelMsg">*</font><span hidden="true" for="password" class="error"></span>
                        </div>
                    </div>

                    <div class="form-group">
                        <input type="hidden" id="provinceId_val" value="${entity.provinceId}">
                    ...
                    <div class="form-group">
                        <input type="hidden" id="cityId_val" value="${entity.cityId}">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入公司地址" type="text"
                                       ...
                                       value="${entity.address}"maxlength="30">
                            </div>
                        </div>
                    </div>
    ...
    <div class="row" style="min-height:60px;">
        <div class="form-group btn-form">
            <div class="col-md-12 text-center">
                <button class="btn btn-footer btn-cancel" type="button" onClick="toInfoScenicList()">取消</button>
                <a href="javascript:;">
        ...
        $("#infoScenicAddForm").validate({
            ...
            submitHandler: function(form) {
               ...
               jQuery(form).ajaxSubmit({
                    type : "post",
                     url: "${ctx}/info/scenic/${entity.id}/edit",
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.flag) {
                    ...
                    // 设置省份数据回显
                    $("#provinceId").val($("#provinceId_val").val()) ;
                } else {
                    $("<option></option>").val("").text("请选择").appendTo("#provinceId") ;
                }
            },
