...
<div class="page-title ">
	<!--列表上方索引 S-->
	<h1 class="fl">
		<span>景区信息</span>&nbsp;&gt;&nbsp;<span class="dq">列表</span>
	</h1>
	<!--列表上方索引 E-->

	<!--列表上方右侧按钮 S-->
	<div class="fr">
		<input class="form-control fl" type="text" style="width:180px;" id="searchName" name="searchName" placeholder="景区名称" />
...
<!-- 列表 -->
<div id="scenic_data_area"></div>


<script type="text/javascript">
    $(document).ready(function() {
        // 页面初始化完成加载list请求
        var requestUrl = "${ctx}/info/scenic/list" ;
        var requestData = {} ;
        ...
        $("#toAdd").click(function() {
            var requestUrl = "${ctx}/info/scenic/toAdd" ;
            var requestData = {} ;
