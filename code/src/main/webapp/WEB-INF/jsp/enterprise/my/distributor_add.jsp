...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>分销商</span>&nbsp;&gt;&nbsp;<span class="dq">新建</span>
    </h1>
    <!--列表上方索引 E-->
            ...
            <div class="widget-container fluid-height">
                ...
                <div class="widget-content padded">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入分销商名称" 
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">分销商主账号：</label>
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入分销商主账号（必须为手机号）" 
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <select class="form-control" id="roleId" name="roleId">
                                    <option value="4" selected="selected">分销商</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3 red-tag tag">
        ...
        $("#addEnterpriseForm").validate({
            ...
            submitHandler: function(form) {
                ...
                jQuery(form).ajaxSubmit({
                    type : "post",
                    url : "${ctx}/my/enterprise/distributor/add",
