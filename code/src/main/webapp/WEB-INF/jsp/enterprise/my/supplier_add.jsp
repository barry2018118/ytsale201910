...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>供应商</span>&nbsp;&gt;&nbsp;<span class="dq">新建</span>
    </h1>
    <!--列表上方索引 E-->
            ...
            <div class="widget-container fluid-height">
                ...
                <div class="widget-content padded">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入供应商名称" 
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">供应商主账号：</label>
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入供应商主账号（必须为手机号）" 
        ...
        $("#addEnterpriseForm").validate({
            ...
            submitHandler: function(form) {
                ...
                jQuery(form).ajaxSubmit({
                    type : "post",
                    url : "${ctx}/my/enterprise/supplier/add",
