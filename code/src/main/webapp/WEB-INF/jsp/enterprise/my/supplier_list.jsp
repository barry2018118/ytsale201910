...
<script type="text/javascript">
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#platformEnterprise_table_details').bootstrapTable({
				...
				url : '${ctx}/my/enterprise/supplier/search',
				method : 'get',
    ...
    function toEdit(id) {
        var requestUrl = "${ctx}/my/enterprise/supplier/" + id + "/toEdit" ;
        var requestData = {} ;
    ...
    function setStatus(id, status) {
        var url = "${ctx}/my/enterprise/supplier/" + id + "/setStatus" ;
        jQuery.ajax({
            type:"post",
            async: true,    
            cache: false,     
    ...
    function doDelete(id) {
        var url = "${ctx}/my/enterprise/supplier/" + id + "/delete" ;
        jQuery.ajax({
            type:"post",
            async: true,    
            cache: false,     
    ...
    function toResetAccount(id) {
        var requestUrl = "${ctx}/my/enterprise/supplier/" + id + "/toResetAccount" ;
        var requestData = {} ;
        cserpLoadPage(requestUrl, requestData, 'GET', 'mainContentDiv') ;
    }
