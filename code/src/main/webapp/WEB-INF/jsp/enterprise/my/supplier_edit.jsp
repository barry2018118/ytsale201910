...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>供应商信息</span>&nbsp;&gt;&nbsp;<span class="dq">编辑</span>
    </h1>
    <!--列表上方索引 E-->
            ...
            <div class="widget-container fluid-height">
                ...
                <div class="widget-content padded">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入供应商名称" type="text" 
        ...
        $("#editEnterpriseForm").validate({
            ...
            submitHandler: function(form) {
                ...
                jQuery(form).ajaxSubmit({
                    type : "post",
                    url : "${ctx}/my/enterprise/supplier/${enterprise.id}/edit",
