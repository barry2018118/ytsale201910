...
<div class="page-title">
    <!--列表上方索引 S-->
    <h1 class="fl">
        <span>平台运营商</span>&nbsp;&gt;&nbsp;<span class="dq">编辑</span>
    </h1>
    <!--列表上方索引 E-->
            ...
            <div class="widget-container fluid-height">
                ...
                <div class="widget-content padded">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入运营商名称" type="text" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入运营商主账号（必须为手机号）" type="text" 
                                    id="username" name="username" value="${user.username}" maxlength="11">
                            </div>
                        </div>
                        <div class="col-md-3 red-tag tag">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入账号密码（必须包含字母和数字）" type="password" 
                                    id="password" name="password" value="${user.password}" maxlength="16">
                            </div>
                        </div>
                        <div class="col-md-3 red-tag tag">
                        ...
                        <div class="col-md-7">
                            <div class="rel">
                                <input class="form-control" placeholder="请输入确认密码" type="password" 
                                    id="password2" name="password2" value="${user.password}" maxlength="16">
                            </div>
                        </div>
                        <div class="col-md-3 red-tag tag">
        ...
        $("#editEnterpriseForm").validate({
            ...
            submitHandler: function(form) {
                ...
                jQuery(form).ajaxSubmit({
                    type : "post",
                    url : "${ctx}/platform/enterprise/${enterprise.id}/edit",
