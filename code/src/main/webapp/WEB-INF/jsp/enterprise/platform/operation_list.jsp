...
<script type="text/javascript">
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#platformEnterprise_table_details').bootstrapTable({
				...
				url : '${ctx}/platform/enterprise/operation/search',
				method : 'get',
    ...
    function toEdit(id) {
        var requestUrl = "${ctx}/platform/enterprise/" + id + "/toEdit" ;
        var requestData = {} ;
    ...
    function setStatus(id, status) {
        var url = "${ctx}/platform/enterprise/" + id + "/setStatus" ;
        jQuery.ajax({
            type:"post",
            async: true,    
            cache: false,     
	...
	function doDelete(id) {
        var url = "${ctx}/platform/enterprise/" + id + "/delete" ;
        jQuery.ajax({
            type:"post",
            async: true,    
            cache: false,     
	...
	function toResetAccount(id) {
        var requestUrl = "${ctx}/platform/enterprise/" + id + "/toResetAccount" ;
        var requestData = {} ;
        cserpLoadPage(requestUrl, requestData, 'GET', 'mainContentDiv') ;
    }
