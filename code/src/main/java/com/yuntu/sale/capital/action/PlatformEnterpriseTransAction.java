...
/**
 * @Description  平台交易资金Action
 * @author zy
 * @date 2018年5月14日
 */
@Controller
@RequestMapping(value = {"/capital/platform/trans"})
public class PlatformEnterpriseTransAction extends BaseAction {
    ...
    public String main(HttpServletRequest request, Model model) {
        return "/capital/platform/trans/main";
    }
    ...
    public String list(HttpServletRequest request, Model model) {
        return "/capital/platform/trans/list";
    }
    ...
    public String accountLogSearch(HttpServletRequest request,Long actionType) {
        ...
        Page<EnterpriseAccountLogPo> page = service.queryByActionType(pager,null, actionType,null,null);
    ...
    public String card(HttpServletRequest request, @PathVariable Long id, Model model)  {
        ...
        return "/capital/platform/trans/card";
    }
}