...
import com.yuntu.sale.base.AlipayConfig;
...
public class AlipayAction extends BaseAction {
	...
	/**
	 * http://www.yunduanxing.com//pay/alipay/test
	 */
	
	@RequestMapping(value = "/test", method = RequestMethod.GET)
	public void testPay(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		//获得初始化的AlipayClient
		...
		alipayRequest.setBizContent("{" + "    \"out_trade_no\":\"20150320010101004\","
	...
	public void payReturn(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("开始同步回调------");
