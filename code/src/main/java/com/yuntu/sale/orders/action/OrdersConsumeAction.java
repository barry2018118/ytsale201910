...
public class OrdersConsumeAction extends BaseAction {
	...
	public String getSearch(HttpServletRequest request, String productNo, String productName) {
		...
		Page<EnterpriseOrdersConsumeVo> page = enterpriseOrdersService.getConsumeList(pager, 
				super.getCurrentUser().getEnterpriseId(), productNo, productName) ;
