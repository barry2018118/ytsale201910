...
public class InfoScenicPo implements Serializable {
	
	private static final long serialVersionUID = 6639033463060574728L;
	/**
	 * Id
	 */
	private Long id;
	...
	public InfoScenicPo() {
		...
		this.sortNo = GrobalConstant.I_NUM_0;
		this.shopNo = GenerateNo.getScenicNo();
	}
